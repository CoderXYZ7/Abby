...
# 2. Build Tools (always rebuild for correct architecture)
echo ""
echo "--- BUILDING TOOLS ---"
...
# Verify it runs
if ! "$ROOT_DIR/player/build/encrypt_util" --help 2>/dev/null; then
    # If --help doesn't exist, just check if it's executable
